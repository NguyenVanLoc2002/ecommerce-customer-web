...
export const ProductGrid = ({ products }: ProductGridProps) => {
  ...
  return (
    <motion.div className="grid grid-cols-2 gap-x-6 gap-y-12 md:grid-cols-3 lg:grid-cols-4 xl:gap-x-8 xl:gap-y-16" {...motionPresets.staggerContainer(Boolean(reducedMotion), 0.05)}>
